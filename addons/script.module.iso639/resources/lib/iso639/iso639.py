...
def _fabtabular():
    ...
    try:
        import xbmc
        data = xbmc.translatePath("special://home/addons/script.module.iso639/resources/lib/iso639/iso-639-3.tab").encode("utf-8")
        inverted = xbmc.translatePath("special://home/addons/script.module.iso639/resources/lib/iso639/iso-639-3_Name_Index.tab").encode("utf-8")
        macro = xbmc.translatePath("special://home/addons/script.module.iso639/resources/lib/iso639/iso-639-3-macrolanguages.tab").encode("utf-8")
        part5 = xbmc.translatePath("special://home/addons/script.module.iso639/resources/lib/iso639/iso639-5.tsv").encode("utf-8")
        part2 = xbmc.translatePath("special://home/addons/script.module.iso639/resources/lib/iso639/iso639-2.tsv").encode("utf-8")
        part1 = xbmc.translatePath("special://home/addons/script.module.iso639/resources/lib/iso639/iso639-1.tsv").encode("utf-8")
    except ImportError:
...
class Iso639(object):
    ...
    def retired(self):
        ...
        def gen():
            ...
            try:
                import xbmc
                iso_3_path = xbmc.translatePath("special://home/addons/script.module.iso639/resources/lib/iso639/iso-639-3_Retirements.tab").encode("utf-8")
            except ImportError:
                from pkg_resources import resource_filename
                iso_3_path = resource_filename(__package__, 'iso-639-3_Retirements.tab')

            with open(iso_3_path) as rf:
