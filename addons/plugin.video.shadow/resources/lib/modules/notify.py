...
XXX_SETTINGS        = xbmcvfs.translatePath(os.path.join('special://home/userdata/addon_data/' + ADDON_ID,'settings.xml'))
PARENTAL_FOLDER     = xbmcvfs.translatePath(os.path.join('special://home/userdata/addon_data/' + ADDON_ID , 'parental'))
DATA_FOLDER         = xbmcvfs.translatePath(os.path.join('special://home/userdata/addon_data/' + ADDON_ID))
ADDON_FOLDER        = xbmcvfs.translatePath(os.path.join('special://home/addons/' + ADDON_ID))
...
I_AGREE        = xbmcvfs.translatePath(os.path.join(DATA_FOLDER , 'agreed.txt'))
BACKGROUND     = xbmcvfs.translatePath(os.path.join('special://home/addons/' + ADDON_ID , 'resources', 'art', 'ContentPanel.png'))
FONTHEADER     = 'Font14'
HEADERIMAGE    = ''
FONTSETTINGS   = 'Font12'
HEADERTYPE     = 'Text'
