import os,re,sys,xbmc,json,base64,string,urllib.request,urllib.parse,urllib.error,requests,shutil,xbmcplugin,xbmcgui,xbmcvfs,socket
from resources.modules import user,client,control
...
def clear_cache():
    ...
    confirm=xbmcgui.Dialog().yesno("Please Confirm","Please Confirm You Wish To Delete Your Kodi Cache Data", "Cancel", "Clear")
    if confirm:
